...
class MakeCars extends VehicleFactory {
    ...
    protected Vehicle makeCars(Enums.VehicleType type){
        ...
        else if(Objects.equals(type, Enums.VehicleType.Sedan))
            vehicle=new Sedan();
        else if(Objects.equals(type, Enums.VehicleType.Convertible))
            vehicle=new Convertible();
        else if(Objects.equals(type, Enums.VehicleType.SUV))
            vehicle=new SUV();
        return vehicle;
    }
}
