...
public class CommandInvoker {
    ...
    // public static Employee official_salesperson;

    public CommandInvoker(Employee salesperson) {
        //store the passed in salesperson in our private variable
        //I ADDED OFFICIAL_SALESPERSON, USED TO JUST BE SALESPERSON
        //official_salesperson = salesperson;
        commands = new Command[] {
            //set up our array of stored commands
            new AskFNCD(), //index 0
            new AskNameCommand(salesperson),//index 1
            new AskTime(salesperson), //index 2
            new AskNewSales(salesperson), //index 3
            new AskInventory(), //index 4
            new AskItemDet(), //index 5
            new AskBuy(salesperson), //index 6
