...
public abstract class Employee implements Utility, Name{
    ...
    public static ArrayList<Employee> getStaffByType(ArrayList<Employee> employeeList, String type) {
        ...
        //this was added for the command line interface
    public Employee getNewSalesPerson(Employee oldSales){
        ...
        // Get a random index from the salesPeople ArrayList
        int randomIndex = rand.nextInt(salesPeople.size());
        // Get a random salesperson from the salesPeople ArrayList
        ...
        while (randomSalesPerson.equals(oldSales)) {
            randomIndex = rand.nextInt(salesPeople.size());
            randomSalesPerson = salesPeople.get(randomIndex);
        }

        // Return the selected random salesperson
        return randomSalesPerson;
